                  ...
                  <div className="row">
                    <div className="col-xl-12">
                      <div className="main-slider__content">
                        <p className="main-slider__sub-title" style={{ color: '#838383'}}>Music Festival</p>
                        <h2 className="main-slider__title" style={{ color: '#838383'}}>
                          Discover a World <br /> <span style={{ color: 'white'}}>of Celebration</span>
                        </h2>
                        ...
                        <div className="main-slider__btn-box">
                          <Link href="/contact" className="main-slider__btn thm-btn" style={{ color: 'white', backgroundColor: '#ef7c25', borderRadius: 30}}>
                            Purchase Ticket
